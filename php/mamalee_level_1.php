...
<html>
  <head>
    ...
    />
    <link
      href="../public/fonts/NanumSquare/nanumsquare.css"
      rel="stylesheet"
      type="text/css"
	/>
	<style>
      ...
      ajax.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            if (upper_menu_id == 2) {
              var restaurants_dropdown = document.querySelector(
                "#restaurants_dropdown"
              );
              var restaurants_hamburger = document.querySelector(
                "#restaurants_hamburger"
              );

              restaurants_dropdown.innerHTML +=
                "<li><a>" + menu_name + "</a></li>";
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            if (upper_menu_id == 1) {
              ...
              var main_bars_hamburger = document.querySelector(
                "#main_bars_hamburger"
              );
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            if (upper_menu_id == 24) {
              ...
              var main_beauty_hamburger = document.querySelector(
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            if (upper_menu_id == 48) {
              ...
              var beauty_hamburger = document.querySelector(
                "#Beauty_hamburger"
              );
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            var menu_name = result[i].menu_name;
            if (upper_menu_id == 33) {
              var fashion_dropdown = document.querySelector(
                "#fashion_dropdown"
              );
              var fashion_hamburger = document.querySelector(
                "#fashion_hamburger"
              );

              fashion_dropdown.innerHTML += "<h5><a>" + menu_name + "</a></h5>";
              fashion_hamburger.innerHTML +=
                "<h5><a>" + menu_name + "</a></h5>";
            }
          }
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            var menu_name = result[i].menu_name;
            if (upper_menu_id == 38) {
              var entertainment_dropdown = document.querySelector(
                "#entertainment_dropdown"
              );
              var entertainment_hamburger = document.querySelector(
          ...
          for (var i = 0; i < result.length; i++) {
            ...
            var menu_name = result[i].menu_name;
            if (upper_menu_id == 43) {
              var services_dropdown = document.querySelector(
                "#services_dropdown"
              );
              var services_hamburger = document.querySelector(
                "#services_hamburger"
              );

              services_dropdown.innerHTML +=
                "<h5><a>" + menu_name + "</a></h5>";
              services_hamburger.innerHTML +=
                "<h5><a>" + menu_name + "</a></h5>";
            }
          }
        }
                    ...
                    <div class="row">
                      <div class="col-sm-2">
                        <ul
                          ...
                          id="restaurants_hamburger"
                        >
                          <h5>Restaurants</h5>
                        </ul>
                      </div>
                      <div class="col-sm-2" id="main_bars_hamburger"></div>
                      <div class="col-sm-2">
                        <ul
                          class="multi-column-dropdown"
                          id="main_beauty_hamburger"
                        >
                          <h5>Beauty & Health</h5>
                        </ul>
                      </div>
                  ...
                  >
                    <div class="row">
                      <div class="col-sm-6">
                        <ul
                          class="multi-column-dropdown"
                          id="restaurants_dropdown"
                        >
                          <h5><a>Restaurants</a></h5>
                        </ul>
                      </div>
                      <div class="col-sm-6" id="main_bars"></div>
                    </div>
                  </ul>
                </li>
                <li class="dropdown">
                  <a
                    ...
                    >Beauty & Health</a
                  >
                  <ul class="dropdown-menu" id="main_beauty"></ul>
                </li>
                <li class="dropdown">
                  <a
                    href=""
                    ...
                    >Fashion</a
                  >
                  <ul class="dropdown-menu" id="fashion_dropdown"></ul>
                </li>
                <li class="dropdown">
                  <a
                    href=""
                    ...
                    >Entertainment</a
                  >
                  <ul class="dropdown-menu" id="entertainment_dropdown"></ul>
                </li>
                <li class="dropdown">
                  <a
                    href=""
                    ...
                    >Services</a
                  >
                  <ul class="dropdown-menu" id="services_dropdown"></ul>
                </li>
              </ul>
            </div>
          </div>
